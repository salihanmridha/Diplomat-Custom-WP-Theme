...
class TMM_Latest_Tweets_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('Displays latest tweets', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Latest Tweets', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => esc_html__('Latest on Twitter', 'diplomat'),
...
class TMM_Social_Links_Widget extends WP_Widget {
	...
	function __construct() {
		//Basic settings
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('Displays website social links', 'diplomat'));

		//Creation
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Social Links', 'diplomat'), $settings);
	}
	...
	function form($instance) {
		//Defaults
		$defaults = array(
			'title' => esc_html__('Social Links', 'diplomat'),
		);
...
class TMM_Contact_Form_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('A widget that shows custom contact form.', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Contact Form', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => esc_html__('Contact Form', 'diplomat'),
			'form' => '',
			'labels' => 'placeholder'
		);
	}
...
class TMM_Flickr_Widget extends WP_Widget {
	...
	function __construct() {
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('Flickr feed widget', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Flickr feed widget', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => esc_html__('Flickr Feed', 'diplomat'),
...
class TMM_Google_Map_Widget extends WP_Widget {
	...
	function __construct() {
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('Custom Google Map widget', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Google Map', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => esc_html__('Our Location', 'diplomat'),
			'width' => '360',
			'height' => '200',
			'mode' => 'image',
			'latitude' => "40.714623",
...
class TMM_Facebook_LikeBox_Widget extends WP_Widget {
	...
	function __construct() {
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('Facebook Like Box widget', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Facebook LikeBox', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => esc_html__('Facebook Like Box', 'diplomat'),
...
class TMM_Contact_Us_Widget extends WP_Widget {
	...
	function __construct() {
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('Contact Us widget', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Contact Us', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => esc_html__('Contact Us', 'diplomat'),
			'address' => '',
			'phone' => '',
			'email' => ''
		);
...
class TMM_Mail_Subscription_Widget extends WP_Widget {
	...
	function __construct() {
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('Mail Subscription widget', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Mail Subscription', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => esc_html__('Keep in touch with us', 'diplomat'),
			'description' => esc_html__('Information about current events related to our company', 'diplomat'),
			'zipcode' => 'true',
			'submit_button' => esc_html__('Enter your email', 'diplomat')
		);
	}
...
class TMM_Recent_Posts_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('Displays recent blog posts', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Popular/Latest/Comments', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => esc_html__('Recent Posts', 'diplomat'),
			'category' => '',
...
class TMM_Video_Widget extends WP_Widget {
	...
	function __construct() {
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('A widget that shows video.', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Video', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => esc_html__('Video Title', 'diplomat'),
			'url' => '',
			'video_cover_image' => '',
...
class TMM_Testimonials_Widget extends WP_Widget {
	...
	function __construct() {
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('A widget that shows testimonials.', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Testimonials', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => esc_html__('Testimonials', 'diplomat'),
			'show' => 'mode1',
			'content' => '',
			'count' => '-1',
			'order' => 'ASC',
...
class TMM_Featured_Boxes extends WP_Widget {
	...
	function __construct() {
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('A widget that shows featured boxes.', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Metro Style', 'diplomat'), $settings);
		$this->defaults = array(
...
class TMM_Accordion_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('A widget that shows accordion.', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Accordion', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => '',
			'acc_titles' => '',
			'acc_bodies' => ''
...
class TMM_Shortcodes_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$settings = array('classname' => __CLASS__, 'description' => esc_html__('A widget that shows the TinyMCE editor with theme shortcodes.', 'diplomat'));
		parent::__construct(__CLASS__, esc_html__('ThemeMakers Editor', 'diplomat'), $settings);
		$this->defaults = array(
			'title' => '',
			'content' => ''
		);
