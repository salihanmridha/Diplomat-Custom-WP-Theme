...
<div class="custom-page-options">       
	...
	<div class="sel">
		<select name="headerbg_hide" class="headerbg_type_image_option">
			<?php
			$options = array(
				0 => esc_html__('No', 'diplomat'),
				1 => esc_html__('Yes', 'diplomat'),
			);
	...
	if ($type == 'post'){
		...
		<div class="sel">
			<select name="post_template" class="post_template_option">
				<?php
				$options = array(
					'default' => esc_html__('Default', 'diplomat'),
					'alternate' => esc_html__('Alternate', 'diplomat'),
				);
    ...
    <div class="sel">
		<select name="footer_sidebar" class="footer_sidebar">
			<?php
			$options = array(
				1 => esc_html__('Display Footer Sidebar', 'diplomat'),
				0 => esc_html__('Do Not Display Footer Sidebar', 'diplomat'),
			);
