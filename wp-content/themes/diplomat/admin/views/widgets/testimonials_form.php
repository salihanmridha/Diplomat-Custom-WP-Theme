...
<?php
$type = array(
    'mode1' => esc_html__('Show selected testimonial', 'diplomat'),
    'mode2' => esc_html__('Show all testimonials', 'diplomat'),
);
...
$orders = array(
    'ASC' => esc_html__('ASC', 'diplomat'),
    'DESC' => esc_html__('DESC', 'diplomat')
);

$ordersby = array(
    'none' => esc_html__('None', 'diplomat'),
    'ID' => esc_html__('ID', 'diplomat'),
    'author' => esc_html__('Author', 'diplomat'),
    'title' => esc_html__('Title', 'diplomat'),
    'name' => esc_html__('Name', 'diplomat'),
    'date' => esc_html__('Date', 'diplomat'),
    'modified' => esc_html__('Modified', 'diplomat'),
    'rand' => esc_html__('Rand', 'diplomat')
);
