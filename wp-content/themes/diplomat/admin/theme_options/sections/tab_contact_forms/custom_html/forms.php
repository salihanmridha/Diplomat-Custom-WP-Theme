...
<div class="js_contact_forms_panel">
	...
	<div class="option option-add-form">
		...
		<h4 class="option-title"><?php esc_html_e('Add New Form', 'diplomat'); ?></h4>
	...
	<ul class="groups contact_forms_groups_list">
		...
		<?php if (!empty($contact_forms) AND is_array($contact_forms)): ?>
			...
			<?php endforeach; ?>
		<?php else: ?>
			<li class="js_no_one_item_else"><span><?php esc_html_e('You have not created any group yet. Please create one using the form above.', 'diplomat'); ?></span></li>
		<?php endif; ?>
	</ul>
<br />
</div>
...
<div style="display: none;" id="contact_form_template">
	...
	<a href="#" class="admin-button button-gray js_back_to_forms_list"><?php esc_html_e('Back to forms list', 'diplomat'); ?></a>
		...
		<div class="form-holder">	
			...
			<div class="option">
				...
				<div class="switch">
					...
					<label for="form-captcha"><span></span><?php esc_html_e('Enable Captcha', 'diplomat'); ?></label>
			...
			<div class="admin-drag-holder clearfix">
				...
				<div class="option option-select contact_form_submit_button">
					...
					TMM_OptionsHelper::draw_theme_option(array(
						...
						'title' => esc_html__('Select submit button', 'diplomat'),
						'type' => 'select',
						'values' => TMM_OptionsHelper::get_theme_buttons(),
						'value' => '',
						'css_class' => '',
						'description' => esc_html__('Button color', 'diplomat'),
					));
					?>				
				</div>
				...
				<div class="option option-text">
					...
					TMM_OptionsHelper::draw_theme_option(array(
						...
						'title' => esc_html__('Submit button text', 'diplomat'),
						'type' => 'text',
						'value' => esc_html__('Submit', 'diplomat'),
						'css_class' => '',
						'description' => esc_html__('Button text', 'diplomat')
					));
					?>
				</div>
				...
				<div class="option option-text">
					...
					TMM_OptionsHelper::draw_theme_option(array(
						...
						'title' => esc_html__('Alternative recipients', 'diplomat'),
						'type' => 'text',
						'value' => "",
						'css_class' => '',
						'description' => esc_html__('Normally site admin gets notifications from all form submitters. Please type here an alternative email address if you want to receive form submission to other mailbox.', 'diplomat')
					));
					?>
				</div>
			...
			<ul class="drag_contact_form_list">
				...
				<li class="admin-drag-holder clearfix">
					...
					TMM_OptionsHelper::draw_theme_option(array(
						...
						'title' => esc_html__('Choose Field Type', 'diplomat'),
						'type' => 'select',
						'values' => TMM_Contact_Form::$types,
						'value' => '',
						'css_class' => 'options_type_select',
						'description' => esc_html__('Please determine a field type here.', 'diplomat')
					));
					?>
					...
					TMM_OptionsHelper::draw_theme_option(array(
						...
						'title' => esc_html__('Field Label / Placeholder', 'diplomat'),
						'type' => 'text',
						'value' => '',
						'css_class' => 'label',
						'description' => esc_html__('To name your field element or group of elements (only for checkbox/radio elements) type the label here.', 'diplomat')
					));
					?>
					...
					<div class="select_options" style="display: none;">
						...
						TMM_OptionsHelper::draw_theme_option(array(
							...
							'title' => esc_html__('Options (comma separated)', 'diplomat'),
							'type' => 'text',
							'value' => '',
							'css_class' => 'options',
							'description' => esc_html__('Type the field options in this field, use commas to split every new option.', 'diplomat')
						));
						?>
					</div>
					...
					<div class="optional_field" style="display: none;">
						...
						TMM_OptionsHelper::draw_theme_option(array(
							...
							'type' => 'checkbox',
							'default_value' => 0,
							'title' => esc_html__('Display Textarea Field', 'diplomat'),
							'description' => esc_html__('If enabled, a new textarea will appear next to current option set, whether for comments or typing a new custom option by user.', 'diplomat'),
							'css_class' => '',
							'value' => 0,
							'id' => ''
						));
					...
					<label class="with-check">
						...
						TMM_OptionsHelper::draw_theme_option(array(
							...
							'type' => 'checkbox',
							'default_value' => 0,
							'title' => esc_html__('Required Field', 'diplomat'),
							'description' => esc_html__('If enabled, it is mandatory field to be filled in.', 'diplomat'),
	...
	<li class="admin-drag-holder clearfix">
		...
		<div class="title_options" style="display: none;">
			...
			TMM_OptionsHelper::draw_theme_option(array(
				...
				'title' => esc_html__('Title Heading', 'diplomat'),
				'type' => 'select',
				'values' => array(
					'h1' => 'H1',
					'h2' => 'H2',
				...
				'value' => '',
				'css_class' => 'options',
				'description' => esc_html__('Choose the necessary heading title to determine a group of elements below.', 'diplomat')
			));
			?>
