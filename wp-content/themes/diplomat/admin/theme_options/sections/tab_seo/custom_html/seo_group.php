...
<a href="#" class="admin-button button-gray js_back_to_seo_list"><?php esc_html_e('Back to groups list', 'diplomat'); ?></a><br />
...
<div class="option">
	...
	<div class="admin-one-half last">
		...
		<div class="add-button add_seo_group_category" group-id="<?php echo $seo_group_id ?>"></div>&nbsp;<strong><?php esc_html_e('Add Category', 'diplomat'); ?></strong>
...
<br />
<h2 style="color: red"><?php esc_html_e('Notice: One SEO group can be used only once per category. In other case it would be used for category as it was picked at first time for category.', 'diplomat'); ?></h2>
