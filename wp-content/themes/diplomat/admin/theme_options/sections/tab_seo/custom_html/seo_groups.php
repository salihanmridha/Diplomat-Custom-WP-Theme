...
<div id="js_seo_groups_panel">
	...
	<div class="option option-add-form">
		...
		<h4 class="option-title"><?php esc_html_e('Add SEO Group', 'diplomat'); ?></h4>
	...
	<div class="option">
		...
		<h4 class="option-title"><?php esc_html_e('SEO Groups', 'diplomat'); ?></h4>
				...
				<?php foreach ($seo_groups as $group_id => $seo_group) : ?>
					<?php if ($group_id): ?>
						<li>
							...
							<a href="#" title="<?php esc_html_e('Delete', 'diplomat'); ?>" class="remove js_remove_seo_group" data-id="seo_group_<?php echo $group_id ?>"></a>
							<a data-id="seo_group_<?php echo $group_id; ?>" href="#" title="<?php esc_html_e('Edit', 'diplomat'); ?>" class="edit js_edit_seo_group"></a>
						</li>
					<?php endif; ?>
				<?php endforeach; ?>
			<?php else: ?>
