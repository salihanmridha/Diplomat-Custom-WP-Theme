...
$content = array(
	'block1' => array(
		'title' => esc_html__('Home page', 'diplomat'),
		'type' => 'items_block',
		'items' => array(
			'meta_title_home' => array(
				'title' => esc_html__('Meta title', 'diplomat'),
				'type' => 'text',
				'default_value' => '',
				'description' => esc_html__('SEO title of page. Title - 50-80 characters (usually - 75)', 'diplomat'),
				'custom_html' => ''
			),
			'meta_keywords_home' => array(
				'title' => esc_html__('Meta keywords', 'diplomat'),
				'type' => 'textarea',
				'default_value' => '',
				'description' => esc_html__('Keywords - up to 250 characters', 'diplomat'),
				'custom_html' => ''
			),
			'meta_description_home' => array(
				'title' => esc_html__('Meta description', 'diplomat'),
				'type' => 'textarea',
				'default_value' => '',
				'description' => esc_html__('Description - about 150-200 characters', 'diplomat'),
				'custom_html' => ''
			),
		)
	),
	'block2' => array(
		'title' => esc_html__('Posts listing/Blog page', 'diplomat'),
		'type' => 'items_block',
		'items' => array(
	...
	'block3' => array(
		'title' => esc_html__('Portfolio listing', 'diplomat'),
		'type' => 'items_block',
		'items' => array(
		...
		/*
		  'block4' => array(
		  'title' => esc_html__('Gallery listing', 'diplomat'),
		  'type' => 'items_block',
		  'items' => array(
...
$child_sections['seo_groups_tab'] = array(
	'name' => esc_html__('SEO Groups', 'diplomat'),
	'sections' => array(
		'seo_groups' => array(
			'title' => '',
			'type' => 'custom',
