...
<div class="option option-radio">
	...
	<div class="controls">
		...
		<label for="logoimage"><span></span><?php esc_html_e('Image', 'diplomat'); ?></label>&nbsp; &nbsp;
		...
		<label for="logotext"><span></span><?php esc_html_e('Text', 'diplomat'); ?></label>
	</div><!--/ .controls-->
...
<ul class="show-hide-items">
	...
	<li class="logo_img" <?php echo ($logo_type === 'image' ? "" : 'style="display:none;"'); ?>>
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'type' => 'upload',
			'default_value' => '',
			'description' => esc_html__('Upload your logo image here. Recommended dimensions: width <= 300px, height = any. Recommended image types: png, gif, jpg.', 'diplomat'),
			'id' => 'logo_image',
		));
		?>
	...
	<li class="logo_text" <?php echo($logo_type === 'text' ? "" : 'style="display:none;"') ?>>
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'type' => 'text',
			'description' => esc_html__('Type your website name here, it will appear instead of your Logo in text format.', 'diplomat'),
			'default_value' => esc_html__('Diplomat', 'diplomat'),
		...
		TMM_OptionsHelper::draw_theme_option(array(
			'name' => 'logo_font_size',
			'type' => 'select',
			'title'=> esc_html__('Logo Font Size', 'diplomat'),
			'description' => '',
		...
		TMM_OptionsHelper::draw_theme_option(array(
			'name' => 'logo_font',
			'title' => esc_html__('Logo Font Family', 'diplomat'),
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'description' => esc_html__('Logo text color for text logo only. Do not edit this field to use default theme styling.', 'diplomat'),
			'css_class' => '',
			'is_reset' => true
		));
		?>
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'title' => esc_html__('Use Two Colors For Logo', 'diplomat'),
			'type' => 'checkbox',
			'default_value' => 1,
			'description' => '',
		...
		<div class="advanced_logo_options">
			...
			TMM_OptionsHelper::draw_theme_option(array(
				...
				'title' => esc_html__('Split Title with the help "^" symbol', 'diplomat'),
				'type' => 'text',
			...
			TMM_OptionsHelper::draw_theme_option(array(
				...
				'description' => esc_html__('Text color for first part logo only (Light Header Type). Do not edit this field to use default theme styling.', 'diplomat'),
				'css_class' => '',
				'is_reset' => true
			));
			?>
			...
			TMM_OptionsHelper::draw_theme_option(array(
				...
				'description' => esc_html__('Text color for second part logo only (Light Header Type). Do not edit this field to use default theme styling.', 'diplomat'),
				'css_class' => '',
				'is_reset' => true
			));
			?>
			...
			TMM_OptionsHelper::draw_theme_option(array(
				...
				'description' => esc_html__('Text color for first part logo only (Light or Colored Header Type). Do not edit this field to use default theme styling.', 'diplomat'),
				'css_class' => '',
				'is_reset' => true
			));
			?>
			...
			TMM_OptionsHelper::draw_theme_option(array(
				...
				'description' => esc_html__('Text color for second part logo only (Dark or Colored Header Type). Do not edit this field to use default theme styling.', 'diplomat'),
				'css_class' => '',
				'is_reset' => true
			));
			?>
