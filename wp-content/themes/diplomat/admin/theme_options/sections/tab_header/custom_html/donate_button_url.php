...
<h4 class="option-title"><?php esc_html_e('Donate Button Url', 'diplomat'); ?></h4>
...
<div class="option option-radio">
	...
	<div class="controls">
		...
		<label for="donate_link"><span></span><?php esc_html_e('Custom link', 'diplomat'); ?></label>&nbsp; &nbsp;
		...
		<label for="donate_page"><span></span><?php esc_html_e('Select donate page', 'diplomat'); ?></label>
	</div><!--/ .controls-->
...
<ul class="show-hide-items">
	...
	<li class="donate_link" <?php echo ($donate_button_url_type === 'link' ? "" : 'style="display:none;"'); ?>>
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'type' => 'text',
			'default_value' => '',
			'description' => esc_html__('Input donate page url', 'diplomat'),
			'id' => 'donate_link',
	...
	<li class="donate_page" <?php echo($donate_button_url_type === 'page' ? "" : 'style="display:none;"') ?>>
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'default_value' => 0,
			'values' => $pages_list,
			'description' => esc_html__('Select donate page', 'diplomat'),
			'id' => 'donate_page',
