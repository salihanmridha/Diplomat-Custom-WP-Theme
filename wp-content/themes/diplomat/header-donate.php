<?php if (TMM::get_option('show_donate_button') !== '0') {
	...
	<a<?php echo $donate_button_target; ?> href="<?php echo esc_url($donate_button_url); ?>" class="button large donate"><?php echo TMM::get_option('donate_button_text') ? esc_html( TMM::get_option('donate_button_text') ) : esc_html__('Donate', 'diplomat'); ?></a>
