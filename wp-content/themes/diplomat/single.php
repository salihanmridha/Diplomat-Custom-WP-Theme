			...
			<?php if ($blog_single_show_posts_nav !== '0') { ?>
				...
				<div class="single-nav">
					...
					<?php if (!empty($prev_post_url)){ ?>
						...
						<a title="<?php esc_html_e('Previous post', 'diplomat'); ?>" href="<?php echo esc_url($prev_post_url); ?>" class="prev">
							<?php esc_html_e('Previous article', 'diplomat'); ?>
					...
					<?php if (!empty($next_post_url)){ ?>
						...
						<a title="<?php esc_html_e('Next post', 'diplomat'); ?>" href="<?php echo esc_url($next_post_url); ?>" class="next">
							<?php esc_html_e('Next article', 'diplomat'); ?>
					...
					if (!empty($tag_ids)) {
						...
						if (!empty($my_query)) {
							...
							<div class="related-article-area">
								...
								<h2 class="section-title"><?php esc_html_e('Related Articles', 'diplomat'); ?></h2>
