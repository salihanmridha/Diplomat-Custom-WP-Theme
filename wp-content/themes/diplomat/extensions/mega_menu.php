...
class TMM_Menu_Walker extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $icon_type_array = array(
            'icon-paper-plane-2' => esc_html__('Type', 'diplomat') . ': ' . 'icon-paper-plane-2',
            'icon-pencil-7' => esc_html__('Type', 'diplomat') . ': ' . 'icon-pencil-7',
            'icon-beaker-1' => esc_html__('Type', 'diplomat') . ': ' . 'icon-beaker-1',
            'icon-megaphone-3' => esc_html__('Type', 'diplomat') . ': ' . 'icon-megaphone-3',
            'icon-cog-6' => esc_html__('Type', 'diplomat') . ': ' . 'icon-cog-6',
            'icon-lightbulb-3' => esc_html__('Type', 'diplomat') . ': ' . 'icon-lightbulb-3',
            'icon-comment-6' => esc_html__('Type', 'diplomat') . ': ' . 'icon-comment-6',
            'icon-thumbs-up-5' => esc_html__('Type', 'diplomat') . ': ' . 'icon-thumbs-up-5',
            'icon-laptop' => esc_html__('Type', 'diplomat') . ': ' . 'icon-laptop',
            'icon-search' => esc_html__('Type', 'diplomat') . ': ' . 'icon-search',
            'icon-wrench' => esc_html__('Type', 'diplomat') . ': ' . 'icon-wrench',
            'icon-leaf' => esc_html__('Type', 'diplomat') . ': ' . 'icon-leaf',
            'icon-cogs' => esc_html__('Type', 'diplomat') . ': ' . 'icon-cogs',
            'icon-group' => esc_html__('Type', 'diplomat') . ': ' . 'icon-group',
            'icon-folder-close' => esc_html__('Type', 'diplomat') . ': ' . 'icon-folder-close',
            'icon-cloud' => esc_html__('Type', 'diplomat') . ': ' . 'icon-cloud',
            'icon-briefcase' => esc_html__('Type', 'diplomat') . ': ' . 'icon-briefcase',
            'icon-beaker' => esc_html__('Type', 'diplomat') . ': ' . 'icon-beaker',
            'icon-bullhorn' => esc_html__('Type', 'diplomat') . ': ' . 'icon-bullhorn',
            'icon-comment' => esc_html__('Type', 'diplomat') . ': ' . 'icon-comment',
            'icon-globe' => esc_html__('Type', 'diplomat') . ': ' . 'icon-globe',
            'icon-globe-6' => esc_html__('Type', 'diplomat') . ': ' . 'icon-globe-6',
            'icon-heart' => esc_html__('Type', 'diplomat') . ': ' . 'icon-heart',
            'icon-rocket' => esc_html__('Type', 'diplomat') . ': ' . 'icon-rocket',
            'icon-suitcase' => esc_html__('Type', 'diplomat') . ': ' . 'icon-suitcase',
            'icon-pencil' => esc_html__('Type', 'diplomat') . ': ' . 'icon-pencil',
            'icon-params' => esc_html__('Type', 'diplomat') . ': ' . 'icon-params',
            'icon-folder-open' => esc_html__('Type', 'diplomat') . ': ' . 'icon-folder-open',
            'icon-cog' => esc_html__('Type', 'diplomat') . ': ' . 'icon-cog',
            'icon-coffee' => esc_html__('Type', 'diplomat') . ': ' . 'icon-coffee',
            'icon-gift' => esc_html__('Type', 'diplomat') . ': ' . 'icon-gift',
            'icon-home' => esc_html__('Type', 'diplomat') . ': ' . 'icon-home',
            'icon-lightbulb' => esc_html__('Type', 'diplomat') . ': ' . 'icon-lightbulb',
            'icon-thumbs-up' => esc_html__('Type', 'diplomat') . ': ' . 'icon-thumbs-up',
            'icon-umbrella' => esc_html__('Type', 'diplomat') . ': ' . 'icon-umbrella',
            'icon-th-list' => esc_html__('Type', 'diplomat') . ': ' . 'icon-th-list',
            'icon-resize-small' => esc_html__('Type', 'diplomat') . ': ' . 'icon-resize-small',
            'icon-download-alt' => esc_html__('Type', 'diplomat') . ': ' . 'icon-download-alt'
        );
    ...
    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes); ?>" data-parent="<?php echo $item->menu_item_parent ?>">
        <dl class="menu-item-bar">
            <dt class="menu-item-handle">
                <span class="item-title"><?php echo esc_html($title); ?> <i <?php echo $style_ititle ?>><?php esc_html_e(' (column) ', 'diplomat'); ?></i></span>
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            <?php if ('custom' == $item->type) : ?>
                <p class="field-url description description-wide">
                    <label for="edit-menu-item-url-<?php echo $item_id; ?>">
                        <?php esc_html_e('URL', 'diplomat'); ?><br />
            ...
            <p class="description description-thin">
                <label for="edit-menu-item-title-<?php echo $item_id; ?>">
                    <?php esc_html_e('Navigation Label', 'diplomat'); ?><br />
                    <input type="text" id="edit-menu-item-title-<?php echo $item_id; ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo $item_id; ?>]" value="<?php echo esc_attr($item->title); ?>" />
                </label>
            </p>
            <p class="description description-thin">
                <label for="edit-menu-item-attr-title-<?php echo $item_id; ?>">
                    <?php esc_html_e('Title Attribute', 'diplomat'); ?><br />
            ...
            <p class="field-link-target description">
                <label for="edit-menu-item-target-<?php echo $item_id; ?>">
                    ...
                    <?php esc_html_e('Open link in a new window/tab', 'diplomat'); ?>
                </label>
            </p>
            <p class="field-css-classes description description-thin">
                <label for="edit-menu-item-classes-<?php echo $item_id; ?>">
                    <?php esc_html_e('CSS Classes (optional)', 'diplomat'); ?><br />
                    <input type="text" id="edit-menu-item-classes-<?php echo $item_id; ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo $item_id; ?>]" value="<?php echo esc_attr(implode(' ', $item->classes)); ?>" />
                </label>
            </p>
            <p class="field-xfn description description-thin">
                <label for="edit-menu-item-xfn-<?php echo $item_id; ?>">
                    <?php esc_html_e('Link Relationship (XFN)', 'diplomat'); ?><br />
                    <input type="text" id="edit-menu-item-xfn-<?php echo $item_id; ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo $item_id; ?>]" value="<?php echo esc_attr($item->xfn); ?>" />
                </label>
            </p>
            <p class="field-description description description-wide">
                <label for="edit-menu-item-description-<?php echo $item_id; ?>">
                    <?php esc_html_e('Description', 'diplomat'); ?><br />
                        <textarea id="edit-menu-item-description-<?php echo $item_id; ?>" class="widefat edit-menu-item-description" rows="3" cols="20" name="menu-item-description[<?php echo $item_id; ?>]"><?php
                            ...
                            // textarea_escaped
                            ?></textarea>
                    <span class="description"><?php esc_html_e('The description will be displayed in the menu if the current theme supports it.', 'diplomat'); ?></span>
                </label>
            </p>
            ...
            <div class="advanced_menu_options">
                ...
                <div class="use_mega_menu">
                    <label for="edit-menu-item-mega-<?php echo $item_id; ?>">
                        ...
                        <?php esc_html_e('Use as Mega Menu', 'diplomat'); ?>
                    </label>
                </div>
                ...
                <div class="hide_title_menu">
                    <label for="hide-title-menu-item-<?php echo $item_id; ?>">
                        ...
                        <?php esc_html_e('Hide Menu Item Title', 'diplomat'); ?>
                    </label>
                </div>
                ...
                <div class="column_layout_menu" <?php echo $style_column ?>>
                    <label for="column-layout-item-<?php echo $item_id; ?>">
                        ...
                        <?php esc_html_e('Column Type', 'diplomat'); ?>
                ...
                <div class="set_icon_menu" <?php echo $style_icon ?>>
                    <label for="edit-menu-item-icon-<?php echo $item_id; ?>">
                        ...
                        <?php esc_html_e('Icon Type', 'diplomat'); ?>
                ...
                <div class="set_image_menu" <?php echo $style_image; ?>>
                    ...
                    <?php if (!empty($menu_item_image) && ($menu_item_image!='none')) { ?>
                        <a  data-id="<?php echo esc_attr($item_id); ?>" href="#" class="remove_menu_item_image"><?php esc_html_e('Remove featured image', 'diplomat'); ?></a>
                    <?php } else { ?>
                        <a  data-id="<?php echo esc_attr($item_id); ?>" href="#" class="add_menu_item_image"><?php esc_html_e('Add Featured Image', 'diplomat'); ?></a>
                    <?php } ?>
                ...
                <div class="set_shortcode_menu">
                    ...
                    <a href="#" data-id="<?php echo esc_attr($editor_id); ?>" class="show_editor" ><?php esc_html_e('Show advanced editor', 'diplomat'); ?></a>
            ...
            <div class="menu-item-actions description-wide submitbox">
                ...
                ?>"><?php esc_html_e('Remove', 'diplomat'); ?>
                </a>
                <span class="meta-sep"> | </span>
                <a class="item-cancel submitcancel" id="cancel-<?php echo $item_id; ?>" href="<?php echo esc_url(add_query_arg(array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg($removed_args, admin_url('nav-menus.php')))); ?>#menu-item-settings-<?php echo $item_id; ?>"><?php esc_html_e('Cancel', 'diplomat'); ?></a>
            </div>
    ...
    static function nav_menu_meta_box() {
        ...
        add_meta_box('tmm_navmenu_editor_metabox', esc_html__('Custom Box', 'diplomat'), array(__CLASS__, 'editor_menu_custom_box'), 'nav-menus', 'side', 'default');
