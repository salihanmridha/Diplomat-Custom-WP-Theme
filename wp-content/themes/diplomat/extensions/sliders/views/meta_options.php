...
<input type="hidden" value="1" name="tmm_meta_saving" />
    ...
    <div class="slider_options">
        ...
        TMM_Slider :: draw_slider_option(array(
            'title' => esc_html__('Slider Height (px)', 'diplomat'),
            'type' => 'text',
        ...
        */
        TMM_Slider :: draw_slider_option(array(
            'title' => esc_html__('Pagination (On / Off)', 'diplomat'),
            'type' => 'checkbox',
        ...
        TMM_Slider :: draw_slider_option(array(
            'title' => esc_html__('AutoPlay (On / Off)', 'diplomat'),
            'type' => 'checkbox',
        ...
        TMM_Slider :: draw_slider_option(array(
            'title' => esc_html__('Auto Play Delay', 'diplomat'),
            'type' => 'text',
        ...
        TMM_Slider :: draw_slider_option(array(
            'title' => esc_html__('Speed', 'diplomat'),
            'type' => 'text',
