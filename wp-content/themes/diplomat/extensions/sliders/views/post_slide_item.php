            ...
            <div id="slide_options_<?php echo $unique_id ?>" class="post-slide-options" dialog-id="<?php echo esc_attr($unique_id); ?>">
                ...
                <div class="one-half">
                    ...
                    TMM_Slider :: draw_slider_option(array(
                            'title' => esc_html__('Post Title', 'diplomat'),
                            'type' => 'text',
                            'name' => 'post_slides_group[' . $unique_id .'][title]',
                            'default_value' => $post_title,
                            'description' => esc_html__('Leave field empty to hide post title', 'diplomat'),
                    ...
                    TMM_Slider :: draw_slider_option(array(
                            'title' => esc_html__('Post Date', 'diplomat'),
                            'type' => 'select',
                ...
                <div class="one-half">
                    ...
                    TMM_Slider :: draw_slider_option(array(
                            'title' => esc_html__('Post Permalink', 'diplomat'),
                            'type' => 'text',
                    ...
                    TMM_Slider :: draw_slider_option(array(
                            'title' => esc_html__('Show / Hide Author Link', 'diplomat'),
                            'type' => 'checkbox',
                    ...
                    TMM_Slider :: draw_slider_option(array(
                            'title' => esc_html__('Show / Hide Comments Link', 'diplomat'),
                            'type' => 'checkbox',
