...
class TMM_Slider {
	...
	public static function register() {
		self::$easing_effects = array(
			'swing' => esc_html__('Swing', 'diplomat'),
			'easeInQuad' => esc_html__('easeInQuad', 'diplomat'),
			'easeOutQuad' => esc_html__('easeOutQuad', 'diplomat'),
			'easeInOutQuad' => esc_html__('easeInOutQuad', 'diplomat'),
			'easeInCubic' => esc_html__('easeInCubic', 'diplomat'),
			'easeOutCubic' => esc_html__('easeOutCubic', 'diplomat'),
			'easeInOutCubic' => esc_html__('easeInOutCubic', 'diplomat'),
			'easeInQuart' => esc_html__('easeInQuart', 'diplomat'),
			'easeOutQuart' => esc_html__('easeOutQuart', 'diplomat'),
			'easeInOutQuart' => esc_html__('easeInOutQuart', 'diplomat'),
			'easeInQuint' => esc_html__('easeInQuint', 'diplomat'),
			'easeOutQuint' => esc_html__('easeOutQuint', 'diplomat'),
			'easeInOutQuint' => esc_html__('easeInOutQuint', 'diplomat'),
			'easeInExpo' => esc_html__('easeInExpo', 'diplomat'),
			'easeOutExpo' => esc_html__('easeOutExpo', 'diplomat'),
			'easeInOutExpo' => esc_html__('easeInOutExpo', 'diplomat'),
			'easeInSine' => esc_html__('easeInSine', 'diplomat'),
			'easeOutSine' => esc_html__('easeOutSine', 'diplomat'),
			'easeInOutSine' => esc_html__('easeInOutSine', 'diplomat'),
			'easeInCirc' => esc_html__('easeInCirc', 'diplomat'),
			'easeOutCirc' => esc_html__('easeOutCirc', 'diplomat'),
			'easeInOutCirc' => esc_html__('easeInOutCirc', 'diplomat'),
			'easeInElastic' => esc_html__('easeInElastic', 'diplomat'),
			'easeOutElastic' => esc_html__('easeOutElastic', 'diplomat'),
			'easeInOutElastic' => esc_html__('easeInOutElastic', 'diplomat'),
			'easeInBack' => esc_html__('easeInBack', 'diplomat'),
			'easeOutBack' => esc_html__('easeOutBack', 'diplomat'),
			'easeInOutBack' => esc_html__('easeInOutBack', 'diplomat'),
			'easeInBounce' => esc_html__('easeInBounce', 'diplomat'),
			'easeOutBounce' => esc_html__('easeOutBounce', 'diplomat'),
			'easeInOutBounce' => esc_html__('easeInOutBounce', 'diplomat'),
		);
