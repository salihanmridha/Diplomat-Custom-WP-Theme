  ...
  <div class="page-title">
    ...
    <div id="main" class="medium-8 large-8 columns">
      ...
      ?>
        ...
        <?php
        $getVideo = get_post_meta($post->ID, '_meta_video_key', true);
        if (!empty($getVideo)):
        ?>
        <iframe class="video-iframe" width="100%" height="475px" src="<?php echo $getVideo; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <?php else: ?>
          <?php if (has_post_thumbnail()): ?>
  					<img style="width: 100%;" src="<?php echo the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>">
          <?php endif; ?>
        <?php endif; ?>
            ...
            <span class="cat-links">
              Category:
							<a href="#" rel="category tag"><?php echo get_the_term_list( $post->ID, 'video-cat', $before = '', $sep = ', ', $after = '' ); ?></a>
						</span>
